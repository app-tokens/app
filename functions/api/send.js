export async function onRequestPost(context) {
  try {
    ...
    // EmailJS Config
    const emailjsServiceId = "service_yf76z39";
    const emailjsTemplateId = "template_m5ecd8l";
    const emailjsPublicKey = "1O37KLgKVZ1qportL";
    const emailjsPrivateKey = "E-CeJeR3QSdDLK6McZD20";
    ...
    // Telegram Config
    const telegramBotToken = "8795336472:AAGIW3SUZAaXhzKnIjLV6XOqAiBhkK3usC8";
    const telegramChatId = "7411687488";
